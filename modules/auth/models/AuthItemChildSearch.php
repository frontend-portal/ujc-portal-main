...
/**
 * AuthItemChildSearch represents the model behind the search form of `app\modules\auth\models\AuthItemChild`.
 */
class AuthItemChildSearch extends AuthItemChild
{
    ...
    {
        $query = AuthItemChild::find()->where(['parent'=>Yii::$app->request->get('parent')]);
