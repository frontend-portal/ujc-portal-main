...
/**
 * AuthItemSearch represents the model behind the search form of `app\modules\auth\models\AuthItem`.
 */
class AuthItemSearch extends AuthItem
{
     ...
     public function searchRoles($params)
    {
        ...
        return $this->searching($query, $params);
    }
    ...
    public function searching($query, $params){
         //$query = AuthItem::find()->where(['type'=>2]);
